...
<body class="bg-light">
<h2 class="text-center mt-3">Edit a Contact</h2>
<div class="container mt-3">
    <form method="post" action="${pageContext.request.contextPath}/edit/${contact.id}" enctype="multipart/form-data">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="zipCode" name="zipCode" value="${contact.zipCode}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="encounterSummary" name="encounterSummary" value="${contact.encounterSummary}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="companyRole" name="companyRole" value="${contact.companyRole}">
        </div>
        <div class="mb-3">
